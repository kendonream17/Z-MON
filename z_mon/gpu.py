...
def gpuUpdate(self):
    try:
        ...
        self.gpuWidget.givedata(self)
        self.gpuWidget.gpuutildrawarea.queue_draw()
        self.gpuWidget.gpuvramdrawarea.queue_draw()
        self.gpuWidget.gpuencodingdrawarea.queue_draw()
        self.gpuWidget.gpudecodingdrawarea.queue_draw()
    except Exception:
        pass
