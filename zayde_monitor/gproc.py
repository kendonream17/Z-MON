...
try:
    ...
    from zayde_monitor.filter_prefs import filter_process_matching_func

from zayde_monitor import log_dir
from zayde_monitor.utils import normalize_app_id, parse_size_to_bytes
