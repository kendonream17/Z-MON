"""Shared package metadata and filesystem helpers for Zayde Monitor."""
...
APP_NAME = "zayde-monitor"
APP_DISPLAY_NAME = "Zayde Monitor"
SETTINGS_SCHEMA_ID = "com.github.KendonReam.zaydemonitor"

PACKAGE_ROOT = Path(__file__).resolve().parent
PROJECT_ROOT = PACKAGE_ROOT.parent
SCHEMA_FILENAME = "com.github.kendonream.zaydemonitor.gschema.xml"
...
log_dir = Path.home() / "zayde_monitor_log"
